<template>
  <div class="container py-4">
    <!-- 상단 타이틀: 무엇을 선택 중인지 명확히 -->
    <header class="mb-3">
      <h1 class="h4 mb-1">기간 추천 — 옵션 선택</h1>
      <p class="text-muted mb-0">추천에 필요한 정보를 선택해 주세요. 왜 필요한지 각 항목에 설명을 제공합니다.</p>
    </header>
    ...
    <template v-else>
      ...
      <section v-else>
        <CCard>
          <div class="d-flex align-items-center justify-content-between">
            <div>
              <div class="fw-semibold mb-1">옵션 정보 준비 중</div>
