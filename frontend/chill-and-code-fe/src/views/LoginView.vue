    ...
    <div class="w-full lg:w-1/2 flex items-center justify-center p-8 lg:p-12">
      <div class="w-full max-w-md">
        ...
        <div class="bg-white rounded-2xl shadow-2xl border border-gray-100 p-10 lg:p-12">
          ...
          <button
            @click="onGoogleLogin"
            class="w-full flex items-center justify-center gap-3 bg-white border-2 border-gray-300 rounded-xl px-5 py-4 font-medium text-gray-700 hover:bg-gray-50 hover:border-gray-400 hover:shadow-md transition-all"
          >
