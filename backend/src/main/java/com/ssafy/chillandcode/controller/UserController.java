...
public class UserController {
	...
	//회원 정보 조회 (프로필 조회)
	@GetMapping("/{userId}")
	@Operation(summary = "회원 정보 조회", description = "회원 ID를 이용하여 특정 사용자의 정보를 조회합니다.")
	...
	//회원 정보 수정
	@PatchMapping("/{userId}")
	@Operation(summary = "회원 정보 수정", description = "회원 ID와 수정할 정보를 입력받아 사용자 프로필을 변경합니다.")
	...
	@Operation(summary = "회원 탈퇴", description = "특정 사용자를 소프트 삭제 처리합니다. 실제 데이터는 삭제되지 않습니다.")
